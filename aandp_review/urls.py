...
urlpatterns = [
    ...
    #     path('applicants/', views.ApplicantListView.as_view(), name='all-applicants'),
    #     path('apcvmaker-add/', views.form_apcvmaker_add, name='form-apcvmaker-add'),
    ...
    #     path("table-of-scores/", views.table_of_scores_page, name="table-of-scores"),
    ...
    # path('assessment/<int:pk>/update/', views.AssessedPublicationUpdate.as_view(), name='assessment-update'),
