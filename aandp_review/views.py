...
#     }
#     return render(request, "aandp_review/landing_pages/applicant_page.html", context=context)
...
# #     model = Publication
# #     fields = ['pub_title','abstract','publication_type','percent_contribution','position_num','document_path','citation_text']
